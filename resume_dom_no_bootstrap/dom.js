...
function darkMode() {
  ...
  document.getElementsByClassName('social')[0].style.backgroundColor =
    'whitesmoke';
  document.getElementsByClassName('icon-top')[0].style.color =
    'rgb(25, 39, 51)';
  document.getElementsByClassName('icon-top')[1].style.color =
    'rgb(25, 39, 51)';
  document.getElementsByClassName('icon-top')[2].style.color =
    'rgb(25, 39, 51)';
  document.getElementsByClassName('icon-top')[3].style.color =
    'rgb(25, 39, 51)';
